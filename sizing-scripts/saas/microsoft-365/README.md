...
Local improvements include unique temporary app naming, cleanup on failure, device-code authentication, token refresh for long scans, capped Microsoft Graph retry waits, site-level drive failure isolation, progress output, and licensed-user counting that still excludes Microsoft 365 F1.
